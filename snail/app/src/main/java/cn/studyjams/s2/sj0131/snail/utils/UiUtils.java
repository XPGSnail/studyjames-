...
public class UiUtils {
    ...
    public static int dip2px(float dpValue) {
        final float scale = CommonApplication.getInstance().getResources().getDisplayMetrics().density;
        Logger.logPD("density:" + scale);
    ...
    public static Resources getResources() {
        return CommonApplication.getInstance().getResources();
    }
    ...
    //获取屏幕原始尺寸宽度，包括虚拟功能键高度
    public static int geScreenWidth(Context context) {
        int dpi = 0;
        WindowManager windowManager = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
        Display display = windowManager.getDefaultDisplay();
        DisplayMetrics displayMetrics = new DisplayMetrics();
